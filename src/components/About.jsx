    ...
    <section id="about" className="bg-[#0D1117] text-white py-16 px-6 lg:px-32">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 items-start">
        {/* Left - About Text */}
            ...
            Security-focused <span className="text-blue-400">System Engineer</span> & <span className="text-blue-400"> Computer Science graduate</span>
            </h2>

            <p className="text-gray-400 mb-4">
                I am a System Engineer with hands-on experience in network security, system hardening, and cross-platform administration across Linux and Windows environments.
            </p>
            <p className="text-gray-400 mb-4">
                Proficient in automating deployments using Bash and PowerShell, supporting secure infrastructures, and implementing CIS benchmark standards.
            </p>
            <p className="text-gray-400 mb-4">
                I also build robust web applications using React, Node.js, Express, and SQLite, with cloud deployment expertise on AWS (EC2, S3, Route 53) and containerization using Docker.
            </p>
            <p className="text-gray-400">
                My mission is to create resilient, secure, and scalable systems—both at the infrastructure and application layer.
            </p>
            </div>
